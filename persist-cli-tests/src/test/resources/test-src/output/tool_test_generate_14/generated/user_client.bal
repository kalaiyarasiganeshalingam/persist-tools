...
public client class UserClient {
    *persist:AbstractPersistClient;
    ...
    private final map<persist:FieldMetadata> fieldMetadata = {
        ...
        "profile.gender": {'type: string, relation: {entityName: "profile", refTable: "Profile", refField: "gender"}}
    };
    private string[] keyFields = ["id"];

    private final map<persist:JoinMetadata> joinMetadata = {profile: {entity: Profile, fieldName: "profile", refTable: "Profile", refFields: ["userId"], joinColumns: ["id"]}};
